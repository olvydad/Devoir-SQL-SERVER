...
('PAT-2024-0005', 'Laurent', 'C�line', '1987-01-07', 'F', 'O+', '0611223344', 'celine.laurent@email.com', '27 rue de la R�publique, 69003 Lyon'),
('PAT-2024-0006', 'Lefebvre', 'David', '1972-10-19', 'M', 'A+', '0622334455', 'david.lefebvre@email.com', '9 avenue Jean M�decin, 06000 Nice'),
...
('PAT-2025-0003', 'Bertrand', 'Fran�ois', '1977-03-27', 'M', 'AB+', '0666778899', 'francois.bertrand@email.com', '16 boulevard de Strasbourg, 31000 Toulouse');


INSERT INTO Clinique.Consultation (ID_Patient, ID_Medecins, Date_Consultation, Motif, Diagnostic, Statut) VALUES
( NULL,3, '2026-01-05 09:30:00', 'Fi�vre et maux de t�te', 'Grippe saisonni�re', 'terminer'),
(2, 1, '2026-01-06 10:15:00', 'Douleurs abdominales', 'Gastro-ent�rite', 'en attente'),
(NULL, 5, '2026-01-07 14:00:00', 'Toux persistante', 'Bronchite aigu�', 'en attente'),
(4, 2, '2026-01-08 11:30:00', 'Douleur au genou', 'Entorse l�g�re', 'terminer'),
(5, 4, '2026-01-09 15:45:00', '�ruption cutan�e', 'Ecz�ma de contact', 'en cours'),
(6, 7, '2026-01-10 09:00:00', 'Vertiges et fatigue', 'Hypotension art�rielle', 'terminer'),
...
(11, 1, '2026-01-16 09:45:00', 'Tension art�rielle �lev�e', 'Hypertension l�g�re', 'terminer'),
(12, 4, '2026-01-17 14:30:00', 'Probl�me de vision', 'Presbytie', 'terminer'),
(13, 5, '2026-01-18 11:00:00', 'Allergie saisonni�re', 'Rhinite allergique', 'terminer'),
(14, 7, '2026-01-19 15:15:00', 'Insomnie', 'Trouble anxieux', 'terminer'),
(15, 6, '2026-01-20 08:30:00', 'Douleur �paule', 'Tendinite', 'terminer'),
(1, 8, '2026-01-22 16:00:00', 'Suivi grippe', 'Gu�rison compl�te', 'terminer'),
(3, 2, '2026-01-23 10:45:00', 'Renouvellement ordonnance', 'Traitement � reconduire', 'terminer'),
(5, 4, '2026-01-24 09:15:00', 'Piq�re de tique', 'Morsure sans infection', 'terminer'),
(8, 1, '2026-01-25 14:45:00', 'Fi�vre enfant', 'Otite moyenne', 'en attente'),
(12, 3, '2026-01-26 11:30:00', 'Douleur dentaire', 'Carie � traiter', 'en cours');

INSERT INTO Clinique.Medicament (Nom_Commercial, DCI, Categorie, Prix_Unitaire, Stock) VALUES
('Doliprane', 'Parac�tamol', 'Antalgique', 2.50, 150),
('Ibuprof�ne EG', 'Ibuprof�ne', 'Antihypertenseur', 3.20, 80),
...
('Levothyrox', 'L�vothyroxine', 'Antihypertenseur', 8.40, 30),
('Xanax', 'Alprazolam', 'Sedatif', 4.80, 40),
('Piq�re de rappel', 'Cyanocobalamine', 'Antihypertenseur', 7.25, 15),
('Dexeryl', 'Dexpanth�nol', 'Sedatif', 5.90, 55),
('Efferalgan', 'Parac�tamol', 'Antalgique', 3.10, 120);

INSERT INTO Clinique.Prescription (ID_Consultation, ID_Medicament, Posologie, Duree_Jour,Qte) VALUES
(1, 5, '1 comprim� matin et soir', 7,1),
(2, 1, '2 comprim�s le matin', 10,3),
(3, 3, '1 ampoule par jour', 5,5),
(4, 8, '1 sachet 3 fois par jour', 5,6),
(5, 1, '2 comprim�s le soir', 30,10),
(6, 7, '1 comprim� matin, midi et soir', 10,4),
(7, 10, '1 cuill�re � soupe apr�s chaque repas', 15,4),
(8, 2, '1 comprim� par jour', 90,5),
(9, 4, '2 pulv�risations dans chaque narine', 20,6),
(10, 6, '1 comprim� matin et soir', 14,5),
(11, 9, '1 sachet le matin � jeun', 30,5),
(12, 4, '1 comprim� 2 fois par jour', 8,9),
(13, 1, '1 injection sous-cutan�e par semaine', 28,2),
(14, 10, '1 comprim� au coucher', 15,5),
(15, 1, '2 comprim�s 3 fois par jour', 7,3);
