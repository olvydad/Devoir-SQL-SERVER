IF NOT EXISTS (SELECT * FROM sys.databases WHERE name = 'CliniquePlus_BD')
BEGIN
CREATE DATABASE CliniquePlus_BD;
END
...
FOREIGN KEY (ID_Consultation) REFERENCES Clinique.Consultation (ID_Consultation) ON DELETE CASCADE ON UPDATE CASCADE,
CONSTRAINT FK_Prescription_Medicament
FOREIGN KEY (ID_Medicament) REFERENCES Clinique.Medicament (ID_Medicament) ON DELETE CASCADE ON UPDATE CASCADE
);
...
(1, 3, '2026-01-05 09:30:00', 'Fièvre et maux de tête', 'Grippe saisonnière', 'terminer'),
(2, 1, '2026-01-06 10:15:00', 'Douleurs abdominales', 'Gastro-entérite', 'en attente'),
(3, 5, '2026-01-07 14:00:00', 'Toux persistante', 'Bronchite aiguë', 'en attente'),
...
INSERT INTO Clinique.Prescription (ID_Consultation, ID_Medicament, Posologie, Duree_Jour) VALUES
(1, 5, '1 comprimé matin et soir', 7),
(2, 12, '2 comprimés le matin', 10),
(3, 3, '1 ampoule par jour', 5),
(4, 8, '1 sachet 3 fois par jour', 5),
(5, 15, '2 comprimés le soir', 30),
(6, 7, '1 comprimé matin, midi et soir', 10),
(7, 10, '1 cuillère à soupe après chaque repas', 15),
(8, 2, '1 comprimé par jour', 90),
(9, 14, '2 pulvérisations dans chaque narine', 20),
(10, 6, '1 comprimé matin et soir', 14),
(11, 9, '1 sachet le matin à jeun', 30),
(12, 4, '1 comprimé 2 fois par jour', 8),
(13, 11, '1 injection sous-cutanée par semaine', 28),
(14, 13, '1 comprimé au coucher', 15),
(15, 1, '2 comprimés 3 fois par jour', 7);

INSERT INTO Clinique.Facture (ID_Consultation, Montant_Brut, Remis, Statut) VALUES
(31, 120.00, 0, 'paye'),
(22, 250.50, 10, 'impaye'),
(33, 80.00, 0, 'en attente'),
(24, 450.00, 15,  'paye'),
(35, 175.25, 5,  'impaye'),
(36, 320.00, 20,  'paye'),
(27, 95.90, 0,  'paye'),
(38, 520.00, 25,  'en attente'),
(29, 210.00, 0, 'paye'),
(40, 380.50, 30,  'impaye'),
(41, 145.00, 10,  'paye'),
(32, 620.00, 15,  'impaye');
...
SUM (CASE WHEN Statut='terminer' THEN 1 ELSE O
